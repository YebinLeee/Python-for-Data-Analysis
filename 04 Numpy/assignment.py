'''
1. numpy를 사용하여 다음과 행렬을 생성하고, 슬라이싱 기법을 활용하여 [result]와 같은 결과를 출력하는 코드를 작성하시오.
...
'''
2. numpy를 사용하여 다음과 같은 행렬을 생성하고, 산술연산자 및 인덱싱 기법을 활용하여 [result]와 같은 결과를 출력하는 코드를 작성하시오.
